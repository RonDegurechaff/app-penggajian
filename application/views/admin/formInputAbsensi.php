  ...
  <form action="" method="post">
    ...
    <table class="table table-bordered table-striped">
      <tr>
        ...
        <td class="text-center text-dark">NIK</td>
        <td class="text-center text-dark">Nama Pegawai</td>
        <td class="text-center text-dark">Jenis Kelamin</td>
        <td class="text-center text-dark">Jabatan</td>
        <td class="text-center text-dark" width="8%;">Hadir</td>
        <td class="text-center text-dark" width="8%;">Sakit</td>
        <td class="text-center text-dark" width="8%;">Alpha</td>
      </tr>
      ...
      foreach ($inputAbsensi as $a) : ?>
        <tr>
          ...
          <td class="text-center text-dark"><?= $no++; ?></td>
          <td class="text-center text-dark"><?= $a->nik; ?></td>
          <td class="text-center text-dark"><?= $a->nama_pegawai; ?></td>
          <td class="text-center text-dark"><?= $a->jenis_kelamin; ?></td>
          <td class="text-center text-dark"><?= $a->jabatan; ?></td>
          <td><input type="text" name="hadir[]" class="form-control" value="0"></td>
          <td><input type="text" name="sakit[]" class="form-control" value="0"></td>
          <td><input type="text" name="alpa[]" class="form-control" value="0"></td>
        </tr>
      <?php endforeach; ?>
    </table>
  </form>

<div class="container-fluid">
    ...
    <a href="<?php echo base_url('admin/dataJabatan') ?>" class="btn btn-primary mb-3"><i class="fas fa-arrow-left"></i> Kembali</a>

    <div class="card" style="width: 70%; margin-bottom: 100px">
    	<div class="card-body">
            <?php foreach ($jabatan as $j): ?>
                
    		<form method="post" action="<?php echo site_url('admin/dataJabatan/updateDataAksi'); ?>">

  ...
  <div class="card mx-auto" style="width: 40%;">
    ...
    <form>
      <div class="card-body">
        ...
        <!--<center> -->
        <table>
          <button type="submit" class="btn btn-primary mb-2" style="float: left;"><i class="fas fa-sync-alt"></i> Set Data</button>
          <div style="width: 210px; float:right;">
            <a href="<?php echo base_url('admin/LaporanAbsensi/cetakLaporanAbsensi?bulan=' . $bulan), '&tahun=' . $tahun ?>" class="btn btn-success mb-2 ml-2 mr-2"><i class="fas fa-print"></i> Cetak Data Absensi</a>
          </div>
        </table>
        <!--</center> -->
      </div>
